...
#   writer = tf.summary.FileWriter('D:/graduation_project/dummy_logs', sess.graph_def)
...
writer = tf.summary.FileWriter('D:/graduation_project/dummy_logs', tf.get_default_graph())
